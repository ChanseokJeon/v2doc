...
export default class BriefGenerator {
  ...
  async generateBriefMarkdown(brief: ExecutiveBrief, outputPath: string): Promise<void> {
    ...
    md += `*Generated by [v2doc](https://github.com/user/v2doc) | 영상 정보 및 자막의 저작권은 원 제작자에게 있습니다.*\n`;
...
`
  ...
  <footer class="footer">
    ...
    <p>Generated by <a href="https://github.com/user/v2doc">v2doc</a> | 영상 정보 및 자막의 저작권은 원 제작자에게 있습니다.</p>
  </footer>
</body>
</html>`;
  ...
  private renderBriefContent(
    ...
    doc
      ...
      .text(
        normalizeTextForPDF(
          'Generated by v2doc | 영상 정보 및 자막의 저작권은 원 제작자에게 있습니다.'
        ),
        { align: 'center' }
      );
  }
